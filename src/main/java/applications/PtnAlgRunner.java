...
public class PtnAlgRunner {
  ...
  public static void main(String[] args) {
    ...
    if (args[0].equals("help")) {
      System.out.println("Params - " + "GraphName:Str " + "Partitions:Byte "
        + "AlgIters:Int " + "DBDirectory:Str " + "ResultsDir:Str "
        + "DBSyncPeriod:Int");
      return;
    }
    ...
    try {
      ...
      Logger logger = new LoggerMetricsMinimal(graphName, resultsDirectory);
      ...
      PtnAlg ptnAlg =
        new PtnAlgDiDiCSync(memGraph, logger, changeLog, migrator);
