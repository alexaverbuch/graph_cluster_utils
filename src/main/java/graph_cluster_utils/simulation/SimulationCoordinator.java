...
public class SimulationCoordinator implements Queue<ChangeOp> {
	...
	public SimulationCoordinator(Thread ptnAlgThread, Thread accessSimThread) {
		this.ptnAlgReady = true;
		this.accessSimReady = false;

		// Compare-&-Swap instead of Synchronized
